use std::{io::*, sync::mpsc::{Sender}, collections::HashMap};

use serde::{Serialize, Deserialize};

#[macro_export] macro_rules! close_all_session_in_lock {
    ($mgr:ident) => {
...
pub trait Session{
    ...
    fn new( sender : Sender<SessionBase> , clientid : &String , peer_addr : &String) -> Result<Self> where Self: Sized;
    fn id(&self) -> String;
