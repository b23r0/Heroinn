...
pub fn replace_connection_info_to_new_file(path : &String , new_path : &String , new_info : ConnectionInfo) -> Result<()>{
    ...
    if !found{
        return Err(std::io::Error::new(std::io::ErrorKind::NotFound, "Not found flag"));
    }
